...
public class SysLogAspect {
	...
	private void doControllerLog(String content){
		...
		String newContent = String.format("%s:%s,页面地址:%s", DateUtil.systemCurrentDateStr(),content,url);
		doLog(newContent);
	}
	
	private void doServiceLog(String content){
		String newContent = String.format("%s:%s", DateUtil.systemCurrentDateStr(),content);
		doLog(newContent);
	}
	
	private void doDAOLog(String content){
		String newContent = String.format("%s:执行%s", DateUtil.systemCurrentDateStr(),content);
		doLog(newContent);
	}
